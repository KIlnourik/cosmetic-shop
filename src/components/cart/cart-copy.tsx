          ...
          <ul className="cart__list">
            <li className="cart__item cart-item">
              ...
              <div className="quantity">
                <button className="btn btn-icon btn-icon--prev" aria-label="уменьшить количество товара" >
                </button>
                ...
                />
                <button className="btn btn-icon btn-icon--next" aria-label="увеличить количество товара">
                </button>
              </div>
              ...
              <button className="trash-btn" type="button" aria-label="Удалить товар">
                <svg width="10" height="10" aria-hidden="true">
                  <use xlinkHref="#trash-bin"></use>
                </svg>
              </button>
            </li>
            <li className="cart__item cart-item">
